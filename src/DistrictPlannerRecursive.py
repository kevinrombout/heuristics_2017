...
class DistrictPlannerRecursive(object):
    ...
    ADDITIONAL_CLEARANCE_FAMILY   = 1
    ADDITIONAL_CLEARANCE_BUNGALOW = 1
    ADDITIONAL_CLEARANCE_MANSION  = 1
    ...
    def getHouse(self):
        ...
        if (self.groundPlan.number_of_familyhomes < (self.NUMBER_OF_HOUSES * self.groundPlan.MINIMUM_FAMILYHOMES_PERCENTAGE)):
            ...
            residence.minimumClearance = residence.getminimumClearance() + self.ADDITIONAL_CLEARANCE_FAMILY + ADDITIONAL_CLEARANCE_OVERALL
            return residence
            ...
            residence.minimumClearance = residence.getminimumClearance() + self.ADDITIONAL_CLEARANCE_BUNGALOW + ADDITIONAL_CLEARANCE_OVERALL
            return residence
            ...
            residence.minimumClearance = residence.getminimumClearance() + self.ADDITIONAL_CLEARANCE_MANSION + ADDITIONAL_CLEARANCE_OVERALL
            return residence
    ...
    def addToGroundPlan(self, type, x_coordinate, y_coordinate):
        ...
        if (type == 'Mansion'):
            ...
            mansion.minimumClearance = mansion.getminimumClearance() + self.ADDITIONAL_CLEARANCE_FAMILY + ADDITIONAL_CLEARANCE_OVERALL
            ...
            bungalow.minimumClearance = bungalow.getminimumClearance() + self.ADDITIONAL_CLEARANCE_FAMILY + ADDITIONAL_CLEARANCE_OVERALL
            ...
            familyHome.minimumClearance = familyHome.getminimumClearance() + self.ADDITIONAL_CLEARANCE_FAMILY + ADDITIONAL_CLEARANCE_OVERALL
